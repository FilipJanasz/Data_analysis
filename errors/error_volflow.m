function volflow_error_total_absolute=error_volflow(volflow)
 % due to flow meter
        volflow_error_relative=0.0075;   % relative http://www.yokogawa.com/us/products/field-instruments/flowmeters/variable-area-flow-meter-rotameters/ramc.htm?t=1
        % due to module 9203            pg 18 http://www.ni.com/pdf/manuals/375101c.pdf
        [DAS_volflow_err_relative, DAS_volflow_err_abs]=error_DAS_m9208(volflow,5/3600);
        % total
