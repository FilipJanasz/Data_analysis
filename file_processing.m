        ...
        %% Find steady state in the recorded data
            ...
            if st_state_flag
                ...
                for process_counter=1:2
                    [st_state_start(process_counter),st_state_end(process_counter)]=steady_state(st_state_data,av_window,lim_factor,use_mov_av,interactive_flag,file_list,process_counter,directory);
