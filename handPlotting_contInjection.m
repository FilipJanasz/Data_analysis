...
y1st=885;
y1end=970;
y1Dat=steam(2).TF9605.var(y1st:y1end);
y2st=1400;
y2end=1560;
y2Dat=steam(4).TF9605.var(y2st:y2end);
y3st=2480;
y3end=2750;
y3Dat=steam(6).TF9605.var(y3st:y3end);
y4Dat=GHFS(2).GHFS2.var(y1st*100:y1end*100);
y5Dat=GHFS(4).GHFS2.var(y2st*100:y2end*100);
y6Dat=GHFS(6).GHFS2.var(y3st*100:y3end*100);
y7Dat=steam(2).mixFront_TF9605.var;
y8Dat=steam(4).mixFront_TF9605.var;
y9Dat=steam(6).mixFront_TF9605.var;
